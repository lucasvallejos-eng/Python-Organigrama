...
class cambiar_tema(tk.Frame):
    def __init__(self, parent, controller):
        ...
        boton_tema_claro = tk.Button(self, text="Claro (Por defecto)",
                                     ...
                                     fg=controller.color_letra.get(),
                                     font=controller.fuente_botones_chicos,
                                     command=lambda: cambiar_tema_claro())
        ...
        boton_tema_oscuro = tk.Button(self, text="Oscuro",
                                      ...
                                      fg="white",
                                      font=controller.fuente_botones_chicos,
                                      command=lambda: cambiar_tema_oscuro())
        ...
        boton_tema_rosado = tk.Button(self, text="Rosado",
                                      ...
                                      fg="#582876",
                                      font=controller.fuente_botones_chicos,
                                      command=lambda: cambiar_tema_rosado())
        boton_tema_rosado.grid(row=4, column=0, ipady=7, pady=5, padx=10, sticky="ew")

        boton_tema_oscuro_rojo = tk.Button(self, text="Oscuro Rojo",
                                           background="#a80000",
                                           fg="#d4d4d4",
                                           font=controller.fuente_botones_chicos,
                                           command=lambda: cambiar_tema_oscuro_rojo())
        boton_tema_oscuro_rojo.grid(row=5, column=0, ipady=7, pady=5, padx=10, sticky="ew")

        boton_tema_lila = tk.Button(self, text="Lila",
                                    background="#50409a",
                                    fg="#ff7bbf",
                                    font=controller.fuente_botones_chicos,
                                    command=lambda: cambiar_tema_lila()
                                    )
        ...
        boton_tema_oscuro_azul = tk.Button(self, text="Oscuro Azul",
                                           ...
                                           background="#090c9b",
                                           font=controller.fuente_botones_chicos,
                                           command=lambda: cambiar_tema_oscuro_azul())
        boton_tema_oscuro_azul.grid(row=2, column=1, ipady=7, pady=5, padx=10, sticky="ew")
        ...
        def cambiar_tema_rosado():
            controller.tema.set("#f29ad8")
            controller.color_letra.set("#582876")
            controller.color_botones.set("#f658b8")
            controller.imagen_atras.set(r"imagenes/atras_boton.png")
            controller.show_frame(cambiar_tema)

        def cambiar_tema_oscuro_rojo():
            controller.tema.set("#1f1f1f")
            controller.color_letra.set("#d4d4d4")
            controller.color_botones.set("#a80000")
            controller.imagen_atras.set(r"imagenes/atras_boton_oscuro.png")
            controller.show_frame(cambiar_tema)

        def cambiar_tema_lila():
            controller.tema.set("#313866")
            controller.color_letra.set("#ff7bbf")
            controller.color_botones.set("#50409a")
            controller.imagen_atras.set(r"imagenes/atras_boton.png")
            controller.show_frame(cambiar_tema)

        def cambiar_tema_oscuro_azul():
            controller.tema.set("#3c3744")
            controller.color_letra.set("white")
            controller.color_botones.set("#090c9b")
            controller.imagen_atras.set(r"imagenes/atras_boton_oscuro.png")
            controller.show_frame(cambiar_tema)
        ...
        def check_input():
            ...
            if len(leer) < 1 and (dia.get() == "Dia" or mes.get() == "Mes" or anho.get() == "Año"):
                ...
                if len(leer) > 20:
                    ...
                    # messagebox.showwarning("Advertencia", "Fecha invalida")
...
class crear_dependencia(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def check_input():
            if dependencia_parent.get() == "Elegir dependencia:":
    ...
    def __init__(self, parent, controller):
        ...
        def check_input():
            ...
            if funct.ValPersona(self.orgD, campo_CI.get("1.0", 'end-1c')):
                ...
                messagebox.showwarning("Advertencia", "Ya existe esa persona en la base de datos.")

                # y si mejor ponemos  Ya existe una persona con ese numero de CI compruebe sus datos
                ...
                # persAux = Personas(COD=campo_CI.get("1.0", 'end-1c'), DOC="", APE="", NOM="", TEL="", DIR="", DEP="",
                #                  SAL="")
...
class modificar_persona_val(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label_salario = tk.Label(self, text="Salaride la persona:", font=controller.fuente_chica,
                                 fg=controller.color_letra.get(),
                                 background=controller.tema.get(), justify="left")
        label_salario.grid(row=7, column=0, padx=10, pady=10)
...
class graficar_organigrama(tk.Frame):
    def __init__(self, parent, controller):
        ...
        boton_completo.grid(row=1, column=0, padx=10, pady=10, columnspan=3, sticky="ew")
        ...
        boton_parcial.grid(row=2, column=0, padx=10, pady=10, columnspan=3, sticky="ew")
